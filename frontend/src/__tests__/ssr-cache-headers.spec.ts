...
describe('ssrCacheHeaders middleware', () => {
  ...
  it('sets Vary: Cookie on a public product route', () => {
    ...
    ssrCacheHeaders(makeReq('/products/oud-50ml') as Request, res as unknown as Response, next);
  ...
  it('always calls next() so the request continues to the SSR handler', () => {
    ...
    ssrCacheHeaders(makeReq('/account/profile') as Request, res as unknown as Response, next);
  ...
  it('sets Cache-Control: no-store for /account/* routes', () => {
    ...
    ssrCacheHeaders(makeReq('/account/profile') as Request, res as unknown as Response, jest.fn());
  ...
  it('sets Cache-Control: no-store for /account root', () => {
    ...
    ssrCacheHeaders(makeReq('/account') as Request, res as unknown as Response, jest.fn());
  ...
  it('sets Cache-Control: no-store for /checkout/* routes', () => {
    ...
    ssrCacheHeaders(makeReq('/checkout/summary') as Request, res as unknown as Response, jest.fn());
  ...
  it('sets Cache-Control: no-store for /cart', () => {
    ...
    ssrCacheHeaders(makeReq('/cart') as Request, res as unknown as Response, jest.fn());
  ...
  it('sets public s-maxage cache header for /products', () => {
    ...
    ssrCacheHeaders(makeReq('/products') as Request, res as unknown as Response, jest.fn());
  ...
  it('sets public s-maxage cache header for /products/:slug', () => {
    ...
    ssrCacheHeaders(makeReq('/products/rose-eau-de-parfum') as Request, res as unknown as Response, jest.fn());
  ...
  it('sets public s-maxage cache header for /categories/:slug', () => {
    ...
    ssrCacheHeaders(makeReq('/categories/niche') as Request, res as unknown as Response, jest.fn());
  ...
  it('does NOT set Cache-Control: no-store on /category/:slug (CDN-cacheable)', () => {
    ...
    ssrCacheHeaders(makeReq('/category/niche') as Request, res as unknown as Response, jest.fn());
  ...
  it('does NOT set any Cache-Control on the home page (not a catalog or private prefix)', () => {
    ...
    ssrCacheHeaders(makeReq('/') as Request, res as unknown as Response, jest.fn());
  ...
  it('does NOT treat /accountsettings as a private route (prefix must be /account, not contains)', () => {
    ...
    ssrCacheHeaders(makeReq('/accountsettings') as Request, res as unknown as Response, jest.fn());
