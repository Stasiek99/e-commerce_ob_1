...
describe("AppComponent — ChunkLoadError NavigationError recovery", () => {
  ...
  it("does NOT reload when NavigationError is unrelated to chunk loading", fakeAsync(() => {
    ...
    routerEvents$.next(
      new NavigationError(1, "/products/slug", new Error("Network error")),
    );
    tick();
    ...
    beforeEach(async () => {
      ...
      await TestBed.configureTestingModule({
        ...
        providers: [
          ...
          {
            provide: SwUpdate,
            useValue: makeSwUpdateStub(true, versionUpdates$),
          },
    ...
    beforeEach(async () => {
      ...
      await TestBed.configureTestingModule({
        ...
        providers: [
          ...
          {
            provide: SwUpdate,
            useValue: makeSwUpdateStub(false, versionUpdates$),
          },
          { provide: ToastService, useValue: toastStub },
        ],
      })
...
describe("AppComponent — skip-navigation link (WCAG 2.4.1)", () => {
  ...
  it("skip link is the first element child of the app shell", () => {
    const appShell: Element | null =
      fixture.nativeElement.querySelector("tui-root");
