...
function setupWithPlatform(platformId: string): {
  service: AuthService;
  http: HttpTestingController;
  mockChannel: MockChannel;
  BroadcastChannelSpy: jest.Mock;
} {
...
describe("AuthService — BroadcastChannel multi-tab logout", () => {
  ...
  describe("browser platform", () => {
    beforeEach(() => {
      ({ service, http, mockChannel, BroadcastChannelSpy } =
        setupWithPlatform("browser"));
    });
