      ...
      @if (!isVerified()) {
        <div class="verify-banner">
          ...
          <div class="verify-banner__body">
            ...
            <span
              >Sprawdź skrzynkę odbiorczą i kliknij link aktywacyjny, który
              wysłaliśmy przy rejestracji.</span
            >
          </div>
          <button
            tuiButton
      ...
      @if (pwa.canInstall()) {
        <div class="install-banner">
          ...
          <div class="install-banner__body">
            ...
            <span
              >Przeglądaj szybciej bez przeglądarki — prosto z ekranu
              głównego.</span
            >
          </div>
          <button
...
export class DashboardComponent {
  ...
  resend(): void {
    ...
    this.auth.resendVerification().subscribe({
      ...
      error: () => {
        this.toast.error(
          "Nie udało się wysłać emaila. Spróbuj ponownie za chwilę.",
        );
        this.resending = false;
      },
    });
