...
function setup() {
  ...
  TestBed.overrideComponent(OrderListComponent, {
    set: {
      imports: [RouterLink, DatePipe, LowerCasePipe, PricePipe],
      schemas: [NO_ERRORS_SCHEMA, CUSTOM_ELEMENTS_SCHEMA],
    },
  });
...
describe("OrderListComponent — skeleton loading", () => {
  ...
  describe("template rendering", () => {
    it("renders skeleton rows while loading", () => {
      ...
      const skeletonCells = fixture.nativeElement.querySelectorAll(
        ".order-cell [tuiSkeleton]",
      );
    ...
    it("hides skeleton rows after data loads", () => {
      ...
      const skeletonCells =
        fixture.nativeElement.querySelectorAll("[tuiSkeleton]");
