...
@Component({
  ...
  template: `
    <div class="legal-page">
      ...
      <p class="version">
        Zgodnie z ustawą z dnia 30 maja 2014&nbsp;r. o prawach konsumenta (Dz.U.
        2014 poz. 827)
      </p>
      ...
      <div class="cta-box">
        <div class="cta-box__text">
          ...
          <span
            >Złóż zgłoszenie online — bez drukowania i wysyłania e-maili.</span
          >
        </div>
        <a
          [routerLink]="['/returns']"
      ...
      <section>
        ...
        <p>
          Masz prawo odstąpić od niniejszej umowy w terminie
          <strong>14 dni bez podania jakiejkolwiek przyczyny</strong>.
        </p>
        <p>
          Termin do odstąpienia od umowy wygasa po upływie 14 dni od dnia, w
          którym weszłeś/weszłaś w posiadanie towaru lub w którym osoba trzecia
          inna niż przewoźnik i wskazana przez Ciebie weszła w posiadanie
          towaru.
        </p>
        <p>
        ...
        <div class="contact-box">
          ...
          <p>
            E-mail: <strong>{{ s.returnsEmail }}</strong>
          </p>
        </div>
        <p>
        ...
        <p>
          ...
          zamieszczonego poniżej, jednak nie jest to obowiązkowe.
        </p>
        <p>
          Aby zachować termin do odstąpienia od umowy, wystarczy, abyś wysłał(a)
          informację dotyczącą wykonania przysługującego Ci prawa odstąpienia od
      ...
      <section>
        ...
        <p>
          ...
          otrzymane od Ciebie płatności, w tym koszty dostarczenia towaru (z
          wyjątkiem dodatkowych kosztów wynikających z wybranego przez Ciebie
          sposobu dostarczenia innego niż najtańszy zwykły sposób dostarczenia
          oferowany przez nas), niezwłocznie, a w każdym przypadku nie później
          niż 14 dni od dnia, w którym zostaliśmy poinformowani o Twojej decyzji
          o wykonaniu prawa odstąpienia od niniejszej umowy.
        </p>
        <p>
          Zwrotu płatności dokonamy przy użyciu takich samych sposobów
          płatności, jakie zostały przez Ciebie użyte w pierwotnej transakcji,
          chyba że wyraźnie zgodziłeś/zgodziłaś się na inne rozwiązanie; w
          każdym przypadku nie poniesiesz żadnych opłat w związku z tym zwrotem.
        </p>
        <p>
          Możemy wstrzymać się ze zwrotem płatności do czasu otrzymania towaru
          lub do czasu dostarczenia nam dowodu jego odesłania, w zależności od
          tego, które zdarzenie nastąpi wcześniej.
        </p>
        <p>
          Proszę odesłać lub przekazać nam towar niezwłocznie, a w każdym razie
          nie później niż 14 dni od dnia, w którym poinformowałeś/poinformowałaś
          nas o odstąpieniu od niniejszej umowy. Termin jest zachowany, jeżeli
          odeślesz towar przed upływem terminu 14 dni.
        </p>
        <p>Będziesz musiał/a ponieść bezpośrednie koszty zwrotu towarów.</p>
        <p>
          Odpowiadasz tylko za zmniejszenie wartości towarów wynikające z
          korzystania z nich w sposób inny niż było to konieczne do stwierdzenia
      ...
      <section>
        ...
        <div class="form-template">
          ...
          <br />
          <p>
            Adresat: {{ s.legalName }}, {{ s.street }}, {{ s.postalCode }}
            {{ s.city }}, {{ s.returnsEmail }}
          </p>
          <br />
          <p>
            Ja/My(*) niniejszym informuję/informujemy(*) o moim/naszym(*)
            odstąpieniu od umowy sprzedaży następujących rzeczy(*) / o
      ...
      <section>
        ...
        <p class="note">
          Uwaga: perfumy i produkty do pielęgnacji ciała podlegają powyższemu
          wyjątku, jeżeli opakowanie zostało naruszone. Prosimy o zwrot
          produktów w oryginalnym, nienaruszonym opakowaniu.
        </p>
      </section>
    </div>
  `,
