      ...
      >
        <div class="banner__inner">
          <p class="banner__text">
            Używamy plików cookie do analizy ruchu i ulepszania sklepu. Dane są
            przetwarzane anonimowo — nie sprzedajemy ich osobom trzecim.
            <a routerLink="/legal/privacy" class="banner__link"
